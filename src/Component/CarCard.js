...
import '../CSS/Card.css';
 export default function CarCard({id,carimage,year,feul,carname,speeds,steering,peoples,price}){
    return(
        ...
        <h3 className="carname">{carname}</h3>
        <div className="" id="year">
            <h5 className="year_no">{year}</h5>
        </div>
      </div>
...
<h4 className="d-flex m-2" id="price">{price}/<h6>month</h6></h4>

<div className="like-rent">
<button className="btn rounded-4 " id="LikeButton" ><img src="https://icons8.com/icon/37975/love" alt="" id="icon"/></button>
<button type="button" class="btn btn-primary rounded-4 " id="rent_now" >Rent Now</button>
</div>
